...
from app.routers import auth, chat, upload, voice
...
async def on_startup() -> None:
    # Creates the users/conversations/messages/attachments tables on first
    # run (sqlite file is created automatically). Safe to call every boot —
